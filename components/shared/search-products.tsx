...
import { useLazyGetSearchProductsQuery } from "@/store/apiSlice"
...
export const SearchProducts = () => {
    const [trigger, { data, isLoading, isError }] = useLazyGetSearchProductsQuery()
    ...
    }, [trigger, isLoading, inView, search])

    if (isLoading) return <p>Loading...</p>
    if (isError) return <p>Error</p>
    if (data?.length === 0) return <p>Товары не найдены</p>
